...
* A file called `src/routes/about.svelte` corresponds to the `/about` route. A file called `src/routes/instructions/[slug].svelte` corresponds to the `/instructions/:slug` route, in which case `params.slug` is available to the route
